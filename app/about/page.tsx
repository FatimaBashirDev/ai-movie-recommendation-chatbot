...
function StepCard({ number, icon, title, description }: StepCardProps) {
  return (
    <div className="relative group bg-gray-800 rounded-2xl p-8 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10">
      <div className="absolute -top-4 left-8 w-12 h-12 bg-gradient-to-br from-purple-500 to-blue-500 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
        {number}
      </div>
      <div className="mt-4">
...
function TechBadge({ name }: TechBadgeProps) {
  return (
    <div className="px-6 py-3 bg-gray-800 rounded-full border border-gray-700 hover:border-purple-500/50 transition-colors">
